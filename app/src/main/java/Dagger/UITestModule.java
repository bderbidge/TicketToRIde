...
@Module
public class UITestModule extends ModuleBase{

    public static UITestModule instance;

    public static UITestModule instance() {
        if (instance == null) {
           instance = new UITestModule();
        }
        return instance;
    }

    public UITestModule() {
        //these classes are very wrong, but I'm just trying to get them to work for now
        mIGUIFacade = GUIFacadeUITest.instance();
